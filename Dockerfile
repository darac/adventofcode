...
COPY --from=ghcr.io/astral-sh/uv:0.10-python3.13-trixie-slim@sha256:51eeabec8588bf3e6b1fbc6b0ee96e4b055c2aa8bd6301ec0aff8f2ad7a35eba /uv /usr/local/bin/uv
