...
def solve(
    ...
    for line in puzzle.splitlines():
        ...
        left.append(left_location)
        right.append(right_location)
    ...
    if part == "a":
        while left:
            ...
            right.remove(right_location)

            diff = abs(left_location - right_location)
            LOG.debug(
                "Paired %d with %d: diff=%d",
                left_location,
                right_location,
                diff,
            )
        ...
        for left_location in left:
            ...
            LOG.debug(
                ...
                left_location,
                similar,
                left_location * similar,
            )
            result += left_location * similar
