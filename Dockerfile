...
COPY --from=ghcr.io/astral-sh/uv:0.10-python3.13-trixie-slim@sha256:645c625876d01c77393338e2bccf4342ee2447680b3069f37004231fb97e2a62 /uv /usr/local/bin/uv
