...
COPY --from=ghcr.io/astral-sh/uv:0.10-python3.13-trixie-slim@sha256:697839ba6aa3b85c3bf1be7e35c5cda7520848a84133f245b89aee8b50950991 /uv /usr/local/bin/uv
