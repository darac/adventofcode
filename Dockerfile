...
COPY --from=ghcr.io/astral-sh/uv:0.10-python3.13-trixie-slim@sha256:c32d0376532c87fc99725529f3fff54f599f52cc0a38f4e7a19fa2f1d3533c5e /uv /usr/local/bin/uv
